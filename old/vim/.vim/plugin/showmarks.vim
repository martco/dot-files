...
hi default ShowMarksHLl ctermfg=none ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLu ctermfg=none ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLo ctermfg=none ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLm ctermfg=none ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
highlight SignColumn ctermbg=none guibg=darkgrey
